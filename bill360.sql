...
insert  into `b_acceptance`(`_id`,`_invoice`,`_core`,`_category`,`_nature`,`_type`,`_addr`,`_is_finish`) values (1,'青海比亚迪实业有限公司','比亚迪','合资','房地产',1,'青海',1);
...
insert  into `b_datadic`(`id`,`data_Dic_Name`,`data_Dic_Value`) values (1,'企业类别','国有'),(2,'企业类别','股份制'),(3,'企业类别','合资'),(4,'企业类别','独资'),(5,'企业性质','房地产'),(6,'上市主体','恒大'),(7,'上市主体','碧桂园'),(8,'上市主体','华夏幸福'),(9,'上市主体','比亚迪'),(10,'上市主体','中石化'),(11,'上市主体','未填写');
...
insert  into `b_staff`(`_id`,`_name`,`_company`,`_endorse_account`,`_phone`,`_addr`) values (1,'李涛','深圳前海票牛牛商业保理有限公司','0','17322009880','深圳市福田区卓越世纪中心4号楼38A');
